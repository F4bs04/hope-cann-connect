...
import ChatMedico from '@/components/medico-dashboard/ChatMedico';
...
const AreaMedico: React.FC = () => {
  ...
  const renderSection = () => {
    switch (currentSection) {
      ...
      case 'agenda':
        return <AgendaMedica onOpenConsulta={handleOpenConsulta} />;
      case 'prescricoes':
        return <Prescricoes />;
      case 'prontuarios':
        if (showProntuarioAba && selectedPatientId) {
          return <ProntuarioAba patientId={selectedPatientId} onBack={handleBackFromProntuario} />;
        }
        return <Prontuarios onOpenPatient={handleOpenPatient} />;
      case 'pacientes':
        return <Pacientes onOpenPatient={handleOpenPatient} />;
      case 'consulta':
        return <ConsultaView consultaId={selectedConsultaId || 0} onBack={() => handleBackToSection('agenda')} />;
      case 'prontuario':
        return <ProntuarioAba patientId={selectedPatientId || 0} onBack={handleBackFromProntuario} />;
      case 'atestados':
        return <Atestados />;
      case 'receitas':
        return <Receitas />;
