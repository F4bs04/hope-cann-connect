...
const CadastroMedico = () => {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      // Configura a URL para onde o usuário será redirecionado após autenticação com Google
      // Certifique-se que esta URL está configurada nas Auth Settings do Supabase
      const redirectUrl = `${window.location.origin}/complete-registro-medico`;
      
      console.log('Iniciando autenticação com Google. URL de redirecionamento:', redirectUrl);
      ...
      toast({
        ...
        description: "Você será redirecionado para a página do Google.",
      });
      
      // Redireciona para a URL do Google (normalmente o SDK do Supabase já faz isso automaticamente)
      // Mas em alguns casos pode ser necessário fazer manualmente
