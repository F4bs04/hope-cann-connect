...
const DoctorCTA = () => {
  return <section className="hopecann-section py-24 bg-gradient-to-br from-hopecann-teal/5 to-white">
      <div className="hopecann-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {benefits.map((benefit, index) => <div key={index} className="bg-white rounded-xl p-8 shadow-sm border border-green-100 hover:shadow-md hover:border-hopecann-teal/30 transition-all h-full">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8">
            <div className="lg:w-2/3">
              ...
              <ul className="space-y-3 mb-6">
                {["Preencha nosso formulário de cadastro", "Forneça sua documentação profissional", "Participe de nossa breve entrevista online", "Receba acesso à plataforma e comece a atender"].map((step, index) => <li key={index} className="flex items-start">
            ...
            <div className="lg:w-1/3">
              <img alt="Médico parceiro" className="w-full h-auto rounded-lg shadow-md" src="/lovable-uploads/85346101-1749-48db-abe2-b28eb3687e1e.png" />
            </div>
          </div>
        </div>
      </div>
