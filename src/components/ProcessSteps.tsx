...
const ProcessSteps = () => {
  return (
    <section id="como-funciona" className="hopecann-section bg-gradient-to-r from-white to-green-50/50 py-20 bg-green-100">
      <div className="hopecann-container">
        ...
        <div className="mt-16 text-center">
          <Link 
            to="/agendar" 
            className="hopecann-btn-primary bg-hopecann-teal hover:bg-hopecann-teal/90 text-white text-lg"
          >
            Iniciar Tratamento
