    ...
    <section id="como-funciona" className="hopecann-section bg-gradient-to-r from-white to-green-50/50 py-20">
      <div className="hopecann-container">
        ...
        <div className="mt-16 text-center">
          <Link
            to="/agendar"
            className="inline-flex items-center justify-center bg-hopecann-teal text-white px-8 py-3 rounded-full text-lg font-medium hover:bg-hopecann-teal/90 transition-colors btn-hover-scale shadow-md"
          >
            Iniciar Tratamento
