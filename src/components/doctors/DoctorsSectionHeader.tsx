...
const DoctorsSectionHeader = ({
  dbStatus
}: DoctorsSectionHeaderProps) => {
  return <div className="text-center mb-12">
      <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-50">Nossa Equipe Médica</h2>
      ...
      {!dbStatus.success && <div className="mt-4 p-3 bg-orange-100 text-orange-800 rounded-md inline-block text-sm">
