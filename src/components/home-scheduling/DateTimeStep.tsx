            ...
            <div 
              ...
              className={`p-3 border-2 rounded-lg cursor-pointer transition-all duration-300 text-center ${
                selectedDate && selectedDate.getTime() === date.getTime() 
                  ? 'border-3 border-hopecann-green shadow-lg shadow-hopecann-green/30 bg-hopecann-green/5 font-semibold' 
                  : 'border-2 border-gray-200 hover:border-hopecann-teal hover:shadow-md hover:shadow-hopecann-teal/20'
              }`}
          ...
          <>
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-3">
              {timeSlots.map((time, index) => (
                <div 
                  key={index}
                  className={`p-3 border-2 rounded-lg cursor-pointer transition-all duration-300 text-center flex items-center justify-center gap-2 ${
                    selectedTime === time 
                      ? 'border-hopecann-green shadow-md shadow-hopecann-green/20 bg-hopecann-green/5' 
