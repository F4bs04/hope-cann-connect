        ...
        <div className="bg-card p-8 rounded-2xl border shadow-sm hover:shadow-lg transition-all duration-300 hover:scale-[1.02]">
          ...
          <Calendar
            ...
            classNames={{
              ...
              day: "h-12 w-12 p-0 font-medium aria-selected:opacity-100 hover:border-2 hover:border-primary hover:bg-transparent transition-all duration-200 rounded-md",
              day_selected: "bg-primary text-primary-foreground hover:bg-primary/90 rounded-lg shadow-lg border-0 !important",
