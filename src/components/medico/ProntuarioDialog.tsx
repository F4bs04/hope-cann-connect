...
const ProntuarioDialog: React.FC<ProntuarioDialogProps> = ({ open, onOpenChange }) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Prontuário de {selectedPaciente.nome}</DialogTitle>
        </DialogHeader>
...
export default ProntuarioDialog;
